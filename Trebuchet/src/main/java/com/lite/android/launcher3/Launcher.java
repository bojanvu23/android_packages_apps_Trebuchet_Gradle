...
import com.lite.android.launcher3.DropTarget.DragObject;
import com.lite.android.launcher3.PagedView.PageSwitchListener;
import com.lite.android.launcher3.allapps.AllAppsContainerView;
import com.lite.android.launcher3.compat.AppWidgetManagerCompat;
import com.lite.android.launcher3.compat.LauncherActivityInfoCompat;
import com.lite.android.launcher3.compat.LauncherAppsCompat;
import com.lite.android.launcher3.compat.UserHandleCompat;
import com.lite.android.launcher3.compat.UserManagerCompat;
import com.lite.android.launcher3.list.SettingsPinnedHeaderAdapter;
import com.lite.android.launcher3.model.WidgetsModel;
import com.lite.android.launcher3.settings.SettingsProvider;
import com.lite.android.launcher3.stats.LauncherStats;
import com.lite.android.launcher3.util.ComponentKey;
import com.lite.android.launcher3.util.LongArrayMap;
import com.lite.android.launcher3.util.Thunk;
import com.lite.android.launcher3.widget.PendingAddWidgetInfo;
import com.lite.android.launcher3.widget.WidgetHostViewLoader;
import com.lite.android.launcher3.widget.WidgetsContainerView;
...
public class Launcher extends Activity
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.lite.android.launcher3.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    static final String ACTION_FIRST_LOAD_COMPLETE =
            "com.lite.android.launcher3.action.FIRST_LOAD_COMPLETE";
    ...
    private boolean startActivity(View v, Intent intent, Object tag) {
        ...
        String packageName = "";
        if (tag instanceof ShortcutInfo) {
            packageName = ((ShortcutInfo) tag).getIntent().getComponent().getPackageName();
        } else if (tag instanceof AppInfo) {
            packageName = ((AppInfo) tag).getIntent().getComponent().getPackageName();

        }

        EventTracker.reportApplicationOpenedEvent(getApplicationContext(), packageName);
...
interface DebugIntents {
    static final String DELETE_DATABASE = "com.lite.android.launcher3.action.DELETE_DATABASE";
    static final String MIGRATE_DATABASE = "com.lite.android.launcher3.action.MIGRATE_DATABASE";
}
